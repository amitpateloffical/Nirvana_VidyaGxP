...
<body>
    ...
    <header>
        ...
        <table style="margin-top: 1.5px;">
            <tr>
                <td class="w-30">
                    <strong>GCP-Study No.</strong> {{ $doc->id }}
                </td>
                <td class="w-40">
                    {{ Helpers::getDivisionName($doc->division_id) }}/GCP_Study/{{ Helpers::year($doc->created_at) }}/{{ str_pad($doc->record, 4, '0', STR_PAD_LEFT) }}
                </td>
                <td class="w-30">
