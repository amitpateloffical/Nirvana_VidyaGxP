...
@section('container')
        ...
        $(document).ready(function() {
            $('#ATC_codes').click(function(e) {
                function generateTableRow(serialNumber) {
                    ...
                    '<td><input type="text" name="ATCCodes[' + serialNumber + '][1st_Level]"></td>' +
                    '<td><input type="text" name="ATCCodes[' + serialNumber + '][2nd_Level]"></td>' +
                    '<td><input type="text" name="ATCCodes[' + serialNumber + '][3rd_Level]"></td>' +
                    '<td><input type="text" name="ATCCodes[' + serialNumber + '][4th_Level]"></td>' +
                    '<td><input type="text" name="ATCCodes[' + serialNumber + '][5th_Level]"></td>' +
                    '<td><input type="text" name="ATCCodes[' + serialNumber + '][atc_Code]"></td>' +
                    '<td><input type="text" name="ATCCodes[' + serialNumber + '][substance]"></td>' +
                    '<td><input type="text" name="ATCCodes[' + serialNumber + '][remarks]"></td>' +
                ...
                var tableBody = $('#ATC_codes-first-table');
            ...
            $('#ATC_codes').click(function(e) {
                function generateTableRow(serialNumber) {
                    var html =
                        ...
                        '"></td>' +
                        '<td><input type="text" name="ATCCodes[' + serialNumber + '][atc_Search]"></td>' +
                        '<td><input type="text" name="ATCCodes[' + serialNumber + '][1st_Level]"></td>' +
                        '<td><input type="text" name="ATCCodes[' + serialNumber + '][2nd_Level]"></td>' +
                        '<td><input type="text" name="ATCCodes[' + serialNumber + '][3rd_Level]"></td>' +
                        '<td><input type="text" name="ATCCodes[' + serialNumber + '][4th_Level]"></td>' +
            ...
            $('#Ingredients').click(function(e) {
                function generateTableRow(serialNumber) {
                    ...
                    var html =
                        '<tr>' +
                        '<td><input disabled type="text" name="serial[]" value="' + (serialNumber+1) + '"></td>' +
                        '<td><input type="text" name="ingridents[' + serialNumber + '][ingredient_Type]"></td>' +
                        ' <td><input type="text" name="ingridents[' + serialNumber + '][ingredient_Name]"></td>' +
                        '<td><input type="text" name="ingridents[' + serialNumber + '][ingredient_Strength]"></td>' +
                        '<td><input type="text" name="ingridents[' + serialNumber + '][Specification_Date]"></td>' +
                        '<td><input type="text" name="ingridents[' + serialNumber + '][Remarks]"></td>' +
                        '<td><button type="text" class="removeRow"> Remove </button></td>' +
            ...
            $('#Product_Material').click(function(e) {
                function generateTableRow(serialNumber) {
                    ...
                    var html =
                        ...
                        '"></td>' +
                        '<td><input type="text" name="product[' + serialNumber + '][Batch_number]"></td>' +
                        '<td><input type="text" name="product[' + serialNumber + '][Expiry_date]"></td>' +
                        '<td><input type="text" name="product[' + serialNumber + '][Manufactured_date]"></td>' +
                        '<td><input type="text" name="product[' + serialNumber + '][Disposition_date]"></td>' +
                        '<td><input type="text" name="product[' + serialNumber + '][Comments_date]"></td>' +
            ...
            $('#Packaging_Information').click(function(e) {
                function generateTableRow(serialNumber) {
                    ...
                    var html =
                        ...
                        '<td><input type="text" name="pacaging_information[' + serialNumber + '][Primary_Packaging]"></td>'
                    '<td><input type="text" name="pacaging_information[' + serialNumber + '][Material]"></td>' +
                    '<td><input type="text" name="pacaging_information[' + serialNumber + '][Pack_Size]"></td>' +
                    '<td><input type="text" name="pacaging_information[' + serialNumber + '][Shelf_Life]"></td>' +
                    '<td><input type="text" name="pacaging_information[' + serialNumber + '][Storage_Condition]"></td>' +
                    '<td><input type="text" name="pacaging_information[' + serialNumber + '][Secondary_Packaging]"></td>' +
                    '<td><input type="text" name="pacaging_information[' + serialNumber + '][Remarks]"></td>' +
                    '<td><button type="text" class="removeRow"> Remove </button></td>' +
            ...
            $('#Equipment').click(function(e) {
                function generateTableRow(serialNumber) {
                    ...
                    var html =
                        ...
                        '<td><input disabled type="text" name="serial[]" value="' + serialNumber +
                        '"></td>' +
                        '<td><input type="text" name="pacaging_information[' + serialNumber + '][ProductName]"></td>' +
    ...
    <div id="change-control-fields">
        <div class="container-fluid">
            ...
            <form action="{{ route('psur.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="group-input">
                                        ...
                                        value="{{ Helpers::getDivisionName(session()->get('division')) }}Psur/{{ date('Y') }}/{{ $record_number }}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                                    ...
                                    <div class="group-input input-date">
                                        ...
                                        <div class="calenderauditee">
                                            ...
                                            <input type="date" name="actual_start_date"
                                                ...
                                                oninput="handleDateInput(this, 'actual_start_date')" />
                                        </div>
                                    ...
                                    <div class="group-input input-date">
                                        ...
                                        <div class="calenderauditee">
                                            ...
                                            <input type="date" name="actual_end_date"
                                                min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" class="hide-input"
                                                oninput="handleDateInput(this, 'actual_end_date')" />
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 new-date-data-field">
                                    <div class="group-input input-date">
                                        ...
                                        <div class="calenderauditee">
                                            <input type="text" id="international_birth_date" readonly
                                                placeholder="DD-MMM-YYYY" />
                                            <input type="date" name="international_birth_date"
                                                min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" class="hide-input"
                                                oninput="handleDateInput(this, 'international_birth_date')" />
                                        </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="Route parent API">(Root Parent)API</label>

                                        <select multiple id="root_parent" name="root_parent_api" id="">
                                            <option value="">--Select---</option>
                                            <option value="a">a</option>
                                            <option value="b">b</option>
                                            <option value="c">c</option>
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select multiple id="reference_record" name="route_of_administration"
                                            id="">
                                            <option value="">--Select---</option>
                                            <option value="a">a</option>
                                            <option value="b">b</option>
                                    ...
                                    <div class="group-input">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered" id="ATC_codes-first-table">
                                                ...
                                                <tbody>
                                                    <td><input disabled type="text" name="ATCCodes[0][serial]" value="1">
                                                    </td>
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        <label for="Ingredients">
                                            ...
                                            <button type="button"
                                                onclick="add4Input('Ingredients-first-table')">+</button>
                                            <span class="text-primary" data-bs-toggle="modal"
                                                data-bs-target="#document-details-field-instruction-modal"
                                                style="font-size: 0.8rem; font-weight: 400; cursor: pointer;">
                                                (Launch Instruction)
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 new-date-data-field">
                                    <div class="group-input input-date">
                                        ...
                                        <div class="calenderauditee">
                                            <input type="text" id="planned_submission_date" readonly
                                                placeholder="DD-MMM-YYYY" />
                                ...
                                <div class="col-lg-6 new-date-data-field">
                                    <div class="group-input input-date">
                                        ...
                                        <div class="calenderauditee">
                                            <input type="text" id="actual_submission_date" readonly
                                                placeholder="DD-MMM-YYYY" />
                                ...
                                <div class="col-md-6">
                                    <div class="group-input">
                                        ...
                                        <input type="text" name="procedure_type">
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <input type="text" name="procedure_number" id="procedure_number"
                                            value="">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="(Parent) Reference Member State(RMS)">(Parent) Reference Member
                                            State(RMS)</label>
                                ...
                                <div class="col-lg-12">
                                    <div class="group-input">
                                        <label for="(Parent)Concerned Member States (CMSs)">(Parent)Concerned Member States
                                            (CMSs)</label>
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        <label for="Product_Material">
                                            ...
                                            <button type="button"
                                                onclick="add4Input('Product_Material-first-table')">+</button>
                                            <span class="text-primary" data-bs-toggle="modal"
                                                data-bs-target="#document-details-field-instruction-modal"
                                                style="font-size: 0.8rem; font-weight: 400; cursor: pointer;">
                                                (Launch Instruction)
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered" id="Product_Material-first-table">
                                                ...
                                                <tbody>
                                                    <td><input disabled type="text" name="product[0][serial_number]"
                                                            value="1">
                                                    </td>
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        <label for="Packaging_Information">
                                            ...
                                            <button type="button"
                                                onclick="add4Input('Packaging_Information-first-table')">+</button>
                                            <span class="text-primary" data-bs-toggle="modal"
                                                data-bs-target="#document-details-field-instruction-modal"
                                                style="font-size: 0.8rem; font-weight: 400; cursor: pointer;">
                                                (Launch Instruction)
