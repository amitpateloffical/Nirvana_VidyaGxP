                ...
                <table>
                    <div class="heading">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex" style="gap:15px; margin-right: 20px;"><button type="button"> <a class="text-white" href="{{route('validation.edit', $validation->id) }}">
                                        Back </a>
        ...
        <div class="second-table">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            <strong> Data Field Name :</strong><a href="{{ url('validationAuditTrialDetails', $validation->id) }}">{{ $dataDemo->activity_type  ? : 'Not Applicable' }}</a>
                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">SOP-000{{ $validation->id }}</h4>
            ...
            <div class="modal-body">
                <div class="info-list">
                    <div class="list-item">
                        ...
                        <div>:</div>
                        <div>{{ $validation->division }}/{{ $validation->process }}</div>
                    </div>
                    <div class="list-item">
