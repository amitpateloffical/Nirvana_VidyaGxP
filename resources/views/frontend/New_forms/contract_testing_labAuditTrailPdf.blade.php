...
<body>
    ...
    <header>
        <table>
            <tr>
                <td class="w-70 head">
                    Contract-Testing-Lab Audit Trial Report
                </td>
                <td class="w-30">
                    <div class="logo">
        ...
        <table style="margin-top: 1.5px;">
            <tr>
                <td class="w-30">
                    <strong>Contract-Testing-Lab-Audit No.</strong> {{ $doc->id }}
                </td>
                <td class="w-40">
                    {{ Helpers::getDivisionName($doc->division_id) }}/Contract-Testing-Lab-Audit/{{ Helpers::year($doc->created_at) }}/{{ str_pad($doc->record, 4, '0', STR_PAD_LEFT) }}
                </td>
                <td class="w-30">
