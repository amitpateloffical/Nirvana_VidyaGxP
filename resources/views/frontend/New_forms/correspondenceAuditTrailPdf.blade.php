...
<body>
    ...
    <header>
        <table>
            <tr>
                <td class="w-70 head">
                    Correspondence Audit Trial Report
                </td>
                <td class="w-30">
                    <div class="logo">
        ...
        <table style="margin-top: 1.5px;">
            <tr>
                <td class="w-30">
                    <strong>Correspondence No.</strong> {{ $doc->id }}
                </td>
                <td class="w-40">
                    {{ Helpers::getDivisionName($doc->division_id) }}/Correspondence/{{ Helpers::year($doc->created_at) }}/{{ str_pad($doc->record, 4, '0', STR_PAD_LEFT) }}
                </td>
                <td class="w-30">
