...
@section('container')
    ...
    <div id="change-control-fields">
        <div class="container-fluid">
            ...
            <form action="{{ route('medical-devices') }}" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="group-input">
                                        ...
                                        value="{{ Helpers::getDivisionName(session()->get('division')) }}MEDICAL/{{ date('Y') }}/{{ $record_number }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        {{-- <input id="docname" type="text" name="other_type" maxlength="50" required> --}}
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <textarea class="summernote" name="intended_use" id="summernote-16"></textarea>
                                    </div>
                                </div>
                            </div>
