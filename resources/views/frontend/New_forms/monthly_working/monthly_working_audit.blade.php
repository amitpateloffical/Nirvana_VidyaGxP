                ...
                <table>
                    <div class="heading">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex" style="gap:15px; margin-right: 20px;"><button type="button"> <a class="text-white" href="{{route('monthly_working.edit', $monthly->id)}}">
                                        Back </a>
                        ...
                        <div style="margin-bottom: 5px;  font-weight: bold;"> Originator
                            : {{ Auth::user()->name ? Auth::user()->name : '' }}</div>
        ...
        <div class="second-table">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            <strong> Data Field Name :</strong><a href="{{ url('monthly_workingAuditTrialDetails', $dataDemo->id) }}">{{ $dataDemo->activity_type ? $dataDemo->activity_type : 'Not Applicable' }}</a>
                        </div>
