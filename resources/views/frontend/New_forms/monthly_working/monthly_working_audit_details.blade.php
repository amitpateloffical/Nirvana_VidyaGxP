    ...
    <div class="container-fluid">
        <div class="audit-inner-container">
            ...
            <header>
                ...
                <table>
                    <div class="heading">
                        <!-- <div style="margin-bottom: 5px;  font-weight: bold;"> ID :000</< /div> -->
                        <div style="margin-bottom: 5px;  font-weight: bold;"> Originator :{{ Auth::user()->name }}</div>
                        <div style="margin-bottom: 5px; font-weight: bold;">Short Description : </div>
                        <div style="margin-bottom: 5px;  font-weight: bold;">Due Date Status : </div>
            ...
            <div class="inner-block audit-main">
                <div class="info-list">
                    ...
                    <div class="list-item">
                        ...
                        <div>:</div>
                        {{-- <div>{{ Helpers::getdateFormat1($temp->created_at) }}
                    </div> --}}
