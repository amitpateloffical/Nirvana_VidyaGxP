                ...
                <table>
                    <div class="heading">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex" style="gap:15px; margin-right: 20px;">
                                <button type="button"> <a class="text-white" href="{{route('national_approval.edit',$national->id)}}">
                                        Back </a>
                                </button>
        ...
        <div class="second-table">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            <strong> Data Field Name :</strong><a href="{{ url('npAuditTrialDetails', $dataDemo->id) }}">{{ $dataDemo->activity_type ? $dataDemo->activity_type : 'Not Applicable' }}</a>
                        </div>
