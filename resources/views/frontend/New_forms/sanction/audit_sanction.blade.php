                    ...
                    <div class="heading">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="heading-new">
                                Sanction Audit Trail
                            </div>
                            <div class="d-flex" style="gap:15px; margin-right: 20px;"><button type="button"> <a class="text-white" href="{{route('sanction.edit', $sanction->id) }}">
                                        Back </a>
                        ...
                        <div style="margin-bottom: 5px;  font-weight: bold;"> Originator
                            : {{ $document->user_name ? $document->user_name : '' }}</div>
        ...
        <div class="second-table">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            <strong> Data Field Name :</strong><a href="{{ url('sanctionAuditTrialDetails', $dataDemo->id) }}">{{ $dataDemo->activity_type  ? : 'Not Applicable' }}</a>
                        </div>
