                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="group-input">
                                    ...
                                    <input disabled type="text" name="record" value="{{ Helpers::getDivisionName(session()->get('division')) }}/SANCTION/{{ date('Y') }}/{{ $record_number }}">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="group-input">
                            ...
                            <div class="col-md-6 new-date-data-field">
                                <div class="group-input input-date">
                                    ...
                                    <div class="calenderauditee">
                                        <input type="hidden" value="{{$due_date}}" id="due_date" name="due_date" />
                                        <input type="text" name="due_date" value="{{Helpers::getdateFormat($due_date)}}" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
