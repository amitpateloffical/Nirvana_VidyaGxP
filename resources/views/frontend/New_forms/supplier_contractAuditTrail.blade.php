                    ...
                    <table>
                        <div class="heading">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex" style="gap:15px; margin-right: 20px;"><button type="button"> <a class="text-white" href="{{ route('supplier_contract.edit', $document->id) }}">
                                    Back </a>
                            ...
                            <div style="margin-bottom: 5px; font-weight: bold;">Short Description :
                                {{ $document->short_description_gi }}</div>
