            ...
            <body>
                ...
                <header>
                    ...
                    <div class="buttons-new">
                        <a class="text-white" href="{{ url('/resamplingshow/' . $document->id) }}">
                    ...
                    <table>
                        <div class="heading">
                            ...
                            <div style="margin-bottom: 5px;  font-weight: bold;">Due Date : {{ \Carbon\Carbon::parse($document->due_date)->format('j-F-Y')}}</div>
                            ...
                            <td>
                                <div>
                                    <strong> Data Field Name
                                        :</strong><a href="{{ route('auditDetails', $dataDemo->id) }}">{{ $dataDemo->activity_type ?: 'Not Applicable' }}</a>
                                </div>
