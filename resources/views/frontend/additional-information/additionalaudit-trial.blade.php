                ...
                <header>
                    ...
                    <table>
                        <div class="buttons-new">
                            <a class="text-white" href="{{ url('/additional_information_view/' . $document->id) }}">
                                <button class="button_theme1 mr-2">
                                    Back
                                </button>
                            </a>
                        ...
                        <div class="heading">
                            <div style="margin-bottom: 5px; font-weight: bold;">
                                ...
                                {{ Helpers::divisionNameForQMS($data->division_id) }}/AI
                            </div>

                            <div class="heading-new">
                                Additional Information Audit Trail
                            </div>
