                                                    ...
                                                    <div class="col-6">
                                                        <div class="group-input">
                                                            <label for="Short Description">(Parent) Short Description<span class="text-danger "
                                                                    name="parent_short_description">*</span></label><span id="rchars">255 </span>characters
                                                            remaining
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="group-input">
                                    ...
                                    <input readonly type="text" name="site_division_code"
                                    <input type="hidden" name="site_division_id" value="{{ session()->get('division') }}">
                                </div>
                            </div>
                            {{--  --}}
                            ...
                            <div class="col-lg-6 new-date-data-field">
                                <div class="group-input input-date">
                                    ...
                                    <div class="calenderauditee" disabled>
                                        ...
                                        <input type="date" id="end_date_checkdate_3" disabled name="gi_target_closure_date"
                                            min="yyyy-mm-dd" class="hide-input"
                            ...
                            <div class="col-6">
                                <div class="group-input">
                                    <label for="Short Description">Short Description<span class="text-danger "
                                            name="gi_short_description">*</span></label><span id="rchars">255
                                    </span>characters
                                    remaining
                                    <input id="docname" type="text" name="gi_short_description" maxlength="255"
                                        required>
                                </div>
                            </div>
