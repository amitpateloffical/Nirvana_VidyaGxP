                                        ...
                                        min="min="yyyy-mm-dd" " class="hide-input"
                                                            ...
                                                            <div class="group-input">
                                                                <label for="audit-agenda-grid">
                                                                    ...
                                                                    <span class="text-primary" name="parent_info_on_product_mat_open" data-bs-toggle="modal" data-bs-target="#document-details-field-instruction-modal" style="font-size: 0.8rem; font-weight: 400; cursor: pointer;">
                                                                        (Open)
                                                                    </span>
                                                                </label>
                                                                    ...
                                                                    <table class="table table-bordered" id="Product_Material1" style="width: 100%;">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td><input type="text" name="parent_info_on_product_mat1[0][item_product_code]"></td>
                                                                                <td><input type="text" name="parent_info_on_product_mat1[0][lot_batch_no]"></td>
                                                                                <td><input type="text" name="parent_info_on_product_mat1[0][ar_number]"></td>
                                                                                <td>
                                                                                    <div class="group-input new-date-data-field mb-0">
                                                                                        <div class="input-date">
                                                                                            <div class="calenderauditee">
                                                                                                <input type="text" id="agenda_date0" readonly placeholder="DD-MMM-YYYY" />
                                                                                                <input type="date" name="parent_info_on_product_mat1[0][mfg_date]" min="yyyy-mm-dd" class="hide-input" data-display-id="agenda_date0" data-start-id="agenda_date0" oninput="handleDateInput(this, 'agenda_date0');" />
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                                    ...
                                                                                    <div class="group-input new-date-data-field mb-0">
                                                                                        <div class="input-date ">
                                                                                            <div class="calenderauditee">
                                                                                                ...
                                                                                                <input type="date" name="parent_info_on_product_mat1[0][exp_date]" min="yyyy-mm-dd" class="hide-input" data-display-id="agenda_date2" data-start-id="agenda_date2" oninput="handleDateInput(this, 'agenda_date2');" />
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                                <td><input type="text" name="parent_info_on_product_mat1[0][label_claim]"></td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="group-input new-date-data-field mb-0">
                                                            <div class="input-date">
                                                                <div class="calenderauditee">
                                                                    <input type="text" id="agenda_date55" readonly placeholder="DD-MMM-YYYY" />
                                                                    <input type="date" name="parent_info_on_product_mat2[0][mfg_date]" min="yyyy-mm-dd" class="hide-input" data-display-id="agenda_date55" data-start-id="agenda_date55" oninput="handleDateInput(this, 'agenda_date55');" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="group-input new-date-data-field mb-0">
                                                            <div class="input-date ">
                                                                <div class="calenderauditee">
                                                                    <input type="text" id="agenda_date56" readonly placeholder="DD-MMM-YYYY" />
                                                                    <input type="date" name="parent_info_on_product_mat2[0][exp_date]" min="yyyy-mm-dd" class="hide-input" data-display-id="agenda_date56" data-start-id="agenda_date56" oninput="handleDateInput(this, 'agenda_date56');" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
