                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                                    <div class="group-input">
                                        ...
                                        <div class="file-attachment-field">
                                            ...
                                            <div class="add-btn">
                                                <div>Add</div>
                                                <input type="file" id="myfile" name="Source_Documents[]"
                                                    oninput="addMultipleFiles(this, 'Source_Documents')" multiple>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <label for="audit-agenda-grid">
                                         Drug Accountability Site (0)
                                            <button type="button" name="audit-agenda-grid"
                                                id="Drug_Accountability_Add">+</button>
                                        </label>
                                        <div class="table-responsive">
                                            <table class="table table-bordered" id="Drug_Accountability_Table"
                                                style="width: 100%;">
                                                <thead>
                                                    <tr>
                                                        <th> Row#</th>
                        ...
                        <div class="col-12">
                            <div class="group-input">
                                ...
                                <select multiple name="attendees" placeholder="" data-search="false"
                ...
                <div class="inner-block-content">
                    <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="group-input">
                                        ...
                                        <div class="file-attachment-field">
                                            ...
                                            <div class="add-btn">
                                                <div>Add</div>
                                                <input type="file" id="HOD_Attachments" name="Consent_Form[]"
                                                    oninput="addMultipleFiles(this, 'Consent_Form')" multiple>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="group-input">
                                        ...
                                        <div class="file-attachment-field">
                                            ...
                                            <div class="add-btn">
                                                <div>Add</div>
                                                <input type="file" id="HOD_Attachments" name="Attached_Payments[]"
                                                    oninput="addMultipleFiles(this, 'Attached_Payments')" multiple>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="group-input">
                                        <label for="audit-agenda-grid">
                                         Financial Transactions (0)
                                            <button type="button" name="audit-agenda-grid"
                                                id="Financial_Transactions_Add">+</button>
                                        </label>
                                        <div class="table-responsive">
                        ...
                        <div class="group-input"> 
                                        ...
                                        <input type="text" name="Lead Investigator"
                                            value="">
                                    </div>
                        </div>
                        <div class="col-lg-6">
                        <div class="group-input"> 
                                        ...
                                        <input type="text" name="Reserve Team Associate"
                                            value="">
                                    </div>
                        </div>
                        <div class="col-6">
