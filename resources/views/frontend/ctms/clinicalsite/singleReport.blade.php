        ...
        <div class="content-table">
            <div class="block">
                ...
                <table>
                    ...
                    <tr>
                        <th class="w-20">Shor Description</th>
                        <td class="w-30">{{ $data->short_description ?? 'Not Applicable' }}</td>
                        <th class="w-20">Assigned To</th>
                        <td class="w-30">{{ $data->assigned_to ?? 'Not Applicable' }}</td>
                    </tr>
                    <tr>
                        <th class="w-20">Due Date</th>
                        <td class="w-30">{{ $data->due_date ?? 'Not Applicable' }}</td>
                        <th class="w-20">Type</th>
                        <td class="w-30">{{ $data->type ?? 'Not Applicable' }}</td>
                    </tr>
                    <tr>
                        <th class="w-20">Name of Site</th>
                        <td class="w-30">{{ $data->site_name ?? 'Not Applicable' }}</td>
                        <th class="w-20">Sponsor</th>
                        <td class="w-30">{{ $data->sponsor ?? 'Not Applicable' }}</td>
                    </tr>
                    <tr>
                        <th class="w-20">Description</th>
                        <td class="w-30">{{ $data->description ?? 'Not Applicable' }}</td>
                        <th class="w-20">Comments</th>
                        <td class="w-30">{{ $data->comments ?? 'Not Applicable' }}</td>
                    </tr>
                    <tr>
                        <th class="w-20"> (Parent) Version No.</th>
                        <td class="w-30">{{ $data->version_no ?? 'Not Applicable' }}</td>
                        <th class="w-20"> (Parent) Admission Criteria  </th>
                        <td class="w-30">{{ $data->admission_criteria ?? 'Not Applicable' }}</td>
                    </tr>
                    <tr>
                        <th class="w-20">(Parent) Clinical Significance</th>
                        <td class="w-30">{{ $data->cinical_significance ?? 'Not Applicable' }}</td>
                        <th class="w-20">(Root Parent) Trade Name</th>
                        <td class="w-30">{{ $data->trade_name ?? 'Not Applicable' }}</td>
                    </tr>
                    <tr>
                        <th class="w-20">(Parent) Tracking Number</th>
                        <td class="w-30">{{ $data->tracking_number ?? 'Not Applicable' }}</td>
                        <th class="w-20">(Parent) Phase of Study</th>
                        <td class="w-30">{{ $data->phase_of_study ?? 'Not Applicable' }}</td>
                    </tr>
                    <tr>
                        <th class="w-20">(Parent) Type </th>
                        <td class="w-30">{{ $data->parent_type ?? 'Not Applicable' }}</td>
                        <th class="w-20">(Parent) Other Type</th>
                        <td class="w-30">{{ $data->par_oth_type ?? 'Not Applicable' }}</td>
                    </tr>
                    <tr>
                        <th class="w-20">Zone</th>
                        <td class="w-30">{{ $data->zone ?? 'Not Applicable' }}</td>
                    ...
                    <tr>
                        ...
                        <td class="w-30">{{ $data->country ?? 'Not Applicable' }}</td>
                        <th class="w-20">City</th>
                        <td class="w-30">{{ $data->city ?? 'Not Applicable' }}</td>
                    </tr>
                    <tr>
                        <th class="w-20"> State/District</th>
                        <td class="w-30">{{ $data->state_district ?? 'Not Applicable' }}</td>
                        <th class="w-20">Site Name</th>
                        <td class="w-30">{{ $data->sel_site_name ?? 'Not Applicable' }}</td>
