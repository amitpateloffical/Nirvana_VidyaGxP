                    ...
                    <table>
                        <div class="heading">
                            ...
                            <div class="heading-new">
                                Ehs Event Audit Trail
                            </div>

                            <div> <strong>Record ID. </strong> {{ Helpers::getDivisionName(session()->get('division')) }}/EHS/{{ date('Y') }}/{{ str_pad($document->record, 4, '0', STR_PAD_LEFT) }}</div>
                            ...
                            <div style="margin-bottom: 5px; font-weight: bold;">Short Description :
                                ...
                                <div style="margin-bottom: 5px; font-weight: bold;">
                                    Due Date: {{ \Carbon\Carbon::parse($document->date_due)->format('j-F-Y') }}
                                </div>
                        ...
                        @foreach ($audit as $audits => $dataDemo)
                            ...
                            <td>
                                ...
                                <div style="margin-top: 5px;">
                                    ...
                                    {{ $dataDemo->created_at ? \Carbon\Carbon::parse($dataDemo->created_at)->format('j-F-Y') : 'Not Applicable' }}
                                </div>
