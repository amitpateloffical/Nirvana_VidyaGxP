                    ...
                    <div class="left-block">
                        ...
                        <div class="tab">
                            ...
                            <div class="divisionlinks">
                                <input type="radio" value="{{ $temp->id }}" name="division_id" onclick="openDivision(event, {{ $temp->id }})" required>
                                <div>{{ $temp->name }}</div>
                            </div>
                            @endforeach
                    ...
                    <div class="right-block">
                        ...
                        <div id="{{ $temp->division_id }}" class="divisioncontent bg-light">
                            ...
                            <label for="process">
                                ...
                                <input type="submit" class="bg-light text-dark" style="width: 100%; height: 60%; background-color: #011627; color: #fdfffc; padding: 7px; border: 0px;" bgcolor="#011627" border="0" type="submit" for="process" value="{{ $test->process_name }}" name="process_name" required>
                            </label>
                            <br>
                            @endforeach
                        </div>
