...
<body>
    ...
    <header>
        <table>
            <tr>
                <td class="w-70 head">
                    Medical Device Registration Audit Trial Report
                </td>
                <td class="w-30">
                    <div class="logo">
        ...
        <table>
            <tr>
                <td class="w-30">
                    <strong>Medical Device Reistration No.</strong>
                </td>
                <td class="w-40">
                    {{ Helpers::getDivisionName($doc->division_id) }}/{{ Helpers::year($doc->created_at) }}/MR/
