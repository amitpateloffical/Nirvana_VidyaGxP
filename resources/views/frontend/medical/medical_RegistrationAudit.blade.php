...
<body>
    ...
    <header>
        <table>
            <tr>
                <td class="w-70 head">
                Medical Device Registration Audit Trail
                </td>
                <td class="w-30">
                    <div class="logo">
        ...
        <table style="margin-top: 5px;">
            <tr>
                <td class="w-30">
                    <strong>Medical Registration Audit No.</strong>
                </td>
                <td class="w-40">

                </td>
                <td class="w-30">
                    <strong>Record No. 000{{$document->record_number}}</strong>
                </td>
            </tr>
        </table>
        <table>
       ...
       <div style="margin-bottom: 5px;  font-weight: bold;">Due Status :  {{$document->due_date_gi}}</div>
            ...
            <table>
                <tr class="table_bg">
                 ...
                 <!-- ----------------------- -->
                        ...
                        <td>
                        <div>
                     <strong> Data Field Name :</strong><a href="{{ url('medical_audit_details', $audits->id) }}">{{ $audits->activity_type }}</a> </div>
