            ...
            <div class="row mb-4">
                ...
                <div class="col-lg-12">
                    <div class="inner-block">
                        <div class="main-head">
                            Record No - <a href="{{ route('medical_edit', $doc->id) }}">{{ str_pad($doc->record_number, 4, '0', STR_PAD_LEFT) }}
                        </div>
                        <div class="info-list">
                            ...
                            <div class="list-item">
                                ...
                                <div>:</div>
                                <div>{{ $doc->status }}</div>@extends('frontend.layout.main')
                                @section('container')
                                    <div id="audit-inner">
                                        <div class="container-fluid">
                                            <div class="audit-inner-container">
                                                ...
                                                <style>
                                                    ...
                                                    <header>
                                                        ...
                                                        <table>
                                                            <div class="heading">
                                                                <div style="margin-bottom: 5px;  font-weight: bold;"> ID :000{{$doc->record_number}}</div>
                                                                ...
                                                                <div style="margin-bottom: 5px;  font-weight: bold;">Due Date Status :  {{$doc->due_date_gi}}</div>
