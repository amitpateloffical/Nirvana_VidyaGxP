...
<body>
    ...
    <div class="inner-block">
        <div class="content-table">
            <div class="block">
                ...
                <table>
                    ...
                    <tr>  
                        ...
                        <td class="w-30">@if($data->parent_oos_no){{$data->parent_oos_no}} @else Not Applicable @endif</td>
                        <th class="w-20">(Parent) OOT No.</th>
                        <td class="w-30">@if($data->parent_oot_no){{$data->parent_oot_no}} @else Not Applicable @endif</td>
                    </tr>
                    <tr>  
                        ...
                        <td class="w-30">@if($data->parent_short_description){{$data->parent_short_description}} @else Not Applicable @endif</td>
                    </tr>
                    <tr>  
                        <th class="w-20">(Parent) Target Closure Date</th>
                        <td class="w-30"> @if($data->target_closure_date){{ $data->target_closure_date }} @else Not Applicable @endif</td>
            ...
            <div class="block">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="w-30" colspan="3"> @if($data->date_opened){{ $data->date_opened }} @else Not Applicable @endif</td>
                        <th class="w-20">Target Closure Date</th>
                        <td class="w-30" colspan="3"> @if($data->target_closure_date){{ $data->target_closure_date }} @else Not Applicable @endif</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="w-80" colspan="3"> @if($data->qc_approver){{ $data->qc_approver }} @else Not Applicable @endif</td>
            ...
            <div class="block">
                <div class="block-head">
                    QC Proposal Comments
                </div>
                <table>
                    <tr>
                        <th class="w-20">QC Comments</th>
                        <td class="w-30">@if($data->qc_comments){{ $data->qc_comments }}@else Not Applicable @endif</td>
                    </tr>
                    <tr>
                        <th class="w-20">Assignee</th>
                        <td class="w-30" > @if($data->qc_approver){{ $data->qc_approver }} @else Not Applicable @endif</td>
                        <th class="w-20">AQA Approver</th>
                        <td class="w-30" > @if($data->aqa_approver){{ $data->aqa_approver }} @else Not Applicable @endif</td>
                    </tr>
                    <tr>
            ...
            <div class="block">
                <div class="block-head">
                    ...
                    <tr>
                        <th class="w-20">Hypo./Exp. Proposed By</th>
                        <td class="w-30">{{ $data->hypo_proposed_by }}</td>
                        <th class="w-20">Hypo./Exp. Proposed On</th>
                        <td class="w-30">{{ Helpers::getdateFormat($data->hypo_proposed_on) }}</td>
                    </tr>
                    <tr>
                        <th class="w-20">Hypothesis Proposed By</th>
                        <td class="w-30">{{ $data->hypothesis_proposed_by }}</td>
                        <th class="w-20">Hypothesis Proposed On</th>
                        <td class="w-30">{{ Helpers::getdateFormat($data->hypothesis_proposed_on) }}</td>
                    </tr>
                    <tr>
                        <th class="w-20">AQA Review Complete  By</th>
                        <td class="w-30">{{ $data->aqa_review_complete_by }}</td>
                        <th class="w-20">AQA Review Complete On</th>
                        <td class="w-30">{{ Helpers::getdateFormat($data->aqa_review_complete_on) }}</td>
                    </tr>
                    <tr>
                        <th class="w-20">AQA Review Complete  By</th>
                        <td class="w-30">{{ $data->aqa_review_complete_by }}</td>
