                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="buttons-new">
                            ...
                            <button class="button_theme1"><a class="text-white"
                                    href="{{ route('preventivemaintenance.view', $document->id) }}"> Back
                                </a>
                            </button>
                    ...
                    <div class="modal fade" id="auditReviewer">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                               ...
                               <form action="{{ route('preventivemaintenance.store_audit_review', $document->id) }}" method="POST">
                                        @csrf
                                        <!-- Modal body -->
                            ...
                            <td>
                                <div>
                                    <strong> Data Field Name :</strong><a
                                        href="{{ route('preventivemaintenance.audit_details', $dataDemo->id) }}">{{ $dataDemo->activity_type ? $dataDemo->activity_type : 'Not Applicable' }}</a>
                                </div>
