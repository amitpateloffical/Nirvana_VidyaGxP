            ...
            <div class="dash-grid">
                ...
                <div>
                    <div class="inner-block scope-table" style="height: calc(100vh - 170px); padding: 0;">
                        ...
                        <<<<<<< HEAD <div class="grid-block">
                            =======
                            <div class="grid-block">
                                >>>>>>> origin/Nirvana_updated24july
                                <div class="group-input">
                                    ...
                                    <option value="Action Item">Action Item</option> --}}
                                        ...
                                        <<<<<<< HEAD {{-- <option value="tms">TMS</option>  --}}=======<option value="GCP Study">GCP Study
                                            </option>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    @elseif ($datas->type == 'External-Audit')
                                                        ...
                                                        @endif
                                                        <<<<<<< HEAD=======>>>>>>> origin/Nirvana_updated24july
                                                        ...
                                                        @elseif($datas->type == 'Root-Cause-Analysis')
                                                            ...
                                                            @endif
                                                            <<<<<<< HEAD
                                                        @elseif($datas->type == 'MedicalDeviceRegistration')=======@elseif($datas->type == 'Product Validation')
                                                        ...
                                                        @elseif($datas->type == 'MedicalDeviceRegistration')
                                                            ...
                                                            @endif
                                                        <<<<<<< HEAD=======@elseif($datas->type == 'Dossier Documents') <a
                                                                href="{{ route('dosierdocuments.view', $datas->id) }}">
                                                            ...
                                                            @elseif($datas->type == 'Preventive Maintenance')
                                                                <a
                                                                    href="{{ route('preventivemaintenance.view', $datas->id) }}">
                                                                    {{ str_pad($datas->id, 4, '0', STR_PAD_LEFT) }}
                                                                </a>
                                                                @if (!empty($datas->parent_id))
                                                                    <a
                                                            ...
                                                            @elseif($datas->type == 'Effectiveness-Check')
                                                                <a
                                                                    href="{{ route('effectiveness.show', $datas->id) }}">
                                                                    {{ str_pad($datas->record, 4, '0', STR_PAD_LEFT) }}
                                                                </a>
                                                                @if (!empty($datas->parent_id))
                                                                    <a
                                                            ...
                                                            @elseif($datas->type == 'Dossier Documents')
                                                                ...
                                                                @elseif($datas->type == 'Gcp-Study')
                                                                    <a
                                                                        href="{{ route('GCP_study.edit', $datas->id) }}">
                                                                        {{ str_pad($datas->record, 4, '0', STR_PAD_LEFT) }}
                                                                    </a>
                                                                    @if (!empty($datas->parent_id))
                                                                        <a
                                                                ...
                                                                @elseif($datas->type == 'Supplier-Contract')
                                                                    <a
                                                                        href="{{ route('supplier_contract.edit', $datas->id) }}">
                                                                        {{ str_pad($datas->record, 4, '0', STR_PAD_LEFT) }}
                                                                    </a>
                                                                    @if (!empty($datas->parent_id))
                                                                        <a
                                                                ...
                                                                @elseif($datas->type == 'Subject-Action-Item')
                                                                    <a
                                                                        href="{{ route('subject_action_item.edit', $datas->id) }}">
                                                                        {{ str_pad($datas->record, 4, '0', STR_PAD_LEFT) }}
                                                                    </a>
                                                                    @if (!empty($datas->parent_id))
                                                                        <a
                                                                ...
                                                                @elseif($datas->type == 'Violation')
                                                                    <a
                                                                        href="{{ route('violation.edit', $datas->id) }}">
                                                                        {{ str_pad($datas->record, 4, '0', STR_PAD_LEFT) }}
                                                                    </a>
                                                                    @if (!empty($datas->parent_id))
                                                                        <a
                                                                ...
                                                                @elseif($datas->type == 'First_product_validation')
                                                                    <a
                                                                        href="{{ route('first_product_validation.edit', $datas->id) }}">
                                                                        {{ str_pad($datas->record, 4, '0', STR_PAD_LEFT) }}
                                                                    </a>
                                                                    @if (!empty($datas->parent_id))
                                                                        <a
                                                                ...
                                                                @elseif($datas->type == 'CTA-Amendement')
                                                                    <a
                                                                        href="{{ route('cta_amendement.edit', $datas->id) }}">
                                                                        {{ str_pad($datas->record, 4, '0', STR_PAD_LEFT) }}
                                                                    </a>
                                                                    @if (!empty($datas->parent_id))
                                                                        <a
                                                                ...
                                                                @elseif($datas->type == 'Correspondence')
                                                                    <a
                                                                        href="{{ route('correspondence.edit', $datas->id) }}">
                                                                        {{ str_pad($datas->record, 4, '0', STR_PAD_LEFT) }}
                                                                    </a>
                                                                    @if (!empty($datas->parent_id))
                                                                        <a
                                                                ...
                                                                @elseif($datas->type == 'CTL-Audit')
                                                                    <a
                                                                        href="{{ route('contract_testing_lab_audit.edit', $datas->id) }}">
                                                                        {{ str_pad($datas->record, 4, '0', STR_PAD_LEFT) }}
                                                                    </a>
                                                                    @if (!empty($datas->parent_id))
                                                                        <a
                                                                            href="{{ url('rcms/qms-dashboard_new', $datas->id) }}/ctl-audit">
                                                                            <div class="icon" onclick="showChild()"
                                                                                data-bs-toggle="tooltip"
                                                                                title="Related Records">
                                                                                {{-- <img src="{{ asset('user/images/parent.png') }}"
