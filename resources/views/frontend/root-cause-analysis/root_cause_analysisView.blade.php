                        ...
                        <div class="inner-block-content">
                            ...
                            @endphp --}}
                                    {{-- <div class="group-input">
                                        ...
                                        <select name="Production_Review" id="Production_Review">
                                            <option value="">-- Select --</option>
                                            <option @if ($data->Production_Review == 'yes') selected @endif value="yes">Yes</option>
                                            <option  @if ($data->Production_Review == 'no') selected @endif  value="no">No</option>
                                            <option  @if ($data->Production_Review == 'na') selected @endif value="na">NA</option>
                                        </select>
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Production_person" id="Production_person" {{$data->stage == 5 ? '' : 'disabled' }} value={{$data->Production_person}}>
                                            <option value="0">-- Select --</option>
                                            @foreach ($users as $user)
                                                <option value="{{ $user->id }}" @if ($user->id == ($data->Production_person?? '')) selected @endif>{{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div> 
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea {{$data->stage == 5 ? '' : 'disabled' }} class="summernote" name="Production_assessment" id="summernote-17" >{{ $data->Production_assessment }} </textarea>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                ...
                                <div class="col-12">
                                  ...
                                  <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input {{$data->stage == 5 ? '' : 'disabled' }} type="text" name="production_by" id="production_by" value={{$data->QualityAssurance_by}}  >
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <!-- <div><small class="text-primary">Please select related information</small></div> -->
                                        <input type="date"id="production_on" name="production_on" value="{{ $data->production_on }}"  {{$data->stage == 5 ? '' : 'disabled' }}>
                                    </div>
                                </div>
                                <div class="sub-head">
                                Warehouse
                           ...
                           <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Warehouse_review" id="Warehouse_review" value={{$data->Warehouse_review}} {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            <option @if ($data->Warehouse_review == 'yes') selected @endif value="yes">Yes</option>
                                            <option @if ($data->Warehouse_review == 'no') selected @endif value="no">No</option>
                                            <option @if ($data->Warehouse_review == 'na') selected @endif value="na">NA</option>
                            ...
                            @endphp
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Warehouse_notification" id="Warehouse_notification" value="{{ $data->Warehouse_notification}}" {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value=""> -- Select --</option>
                                            @foreach ($users as $user)
                                            <option {{ $data->Warehouse_notification == $user->id ? 'selected' : '' }}
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                                        <textarea class="summernote" name="Warehouse_assessment" id="summernote-19">{{ $data->Warehouse_assessment }}
                                    </textarea>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                                        <textarea class="summernote" name="Warehouse_feedback" id="summernote-20">{{ $data->Warehouse_feedback }}</textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <div class="file-attachment-field">
                                            <div disabled class="file-attachment-list" id="Warehouse_attachment">
                                                ...
                                                @foreach(json_decode($data->Warehouse_attachment) as $file)
                                                <h6 type="button" class="file-container text-dark" style="background-color: rgb(243, 242, 240);">
                                                    <b>{{ $file }}</b>
                                                    <a href="{{ asset('upload/' . $file) }}" target="_blank"><i class="fa fa-eye text-primary" style="font-size:20px; margin-right:-10px;"></i></a>
                                                    <a  type="button" class="remove-file" data-file-name="{{ $file }}"><i class="fa-solid fa-circle-xmark" style="color:red; font-size:20px;"></i></a>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input {{$data->stage == 5 ? '' : 'disabled' }} type="text" name="Warehouse_by" id="Warehouse_by" value={{ $data->Warehouse_by }} >
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <!-- <div><small class="text-primary">Please select related information</small></div> -->
                                        <input type="date"id="Warehouse_on" name="Warehouse_on" value="{{ $data->Warehouse_on }}" {{$data->stage == 5 ? '' : 'disabled' }}>
                                    </div>
                                </div>
                                <div class="sub-head">
                                Quality Control
                           ...
                           <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Quality_review" id="Quality_review" value={{$data->Quality_review}} {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="">-- Select --</option>
                                            <option @if ($data->Quality_review == 'yes') selected @endif value="yes">Yes</option>
                                            <option @if ($data->Quality_review == 'no') selected @endif value="no">No</option>
                                            <option @if ($data->Quality_review == 'na') selected @endif value="na">NA</option>
                            ...
                            @endphp
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Quality_Control_Person" id="Quality_Control_Person"value="{{$data->Quality_Control_Person}}" {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="">-- Select --</option>
                                            @foreach ($users as $user)
                                            <option {{ $data->Quality_Control_Person == $user->id ? 'selected' : '' }}
                                                value="{{ $user->id }}">{{ $user->name }}</option>
                                            @endforeach
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                                        <textarea class="summernote" name="Quality_Control_assessment" id="summernote-21">{{ $data->Quality_Control_assessment }}
                                    </textarea>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                                        <textarea class="summernote" name="Quality_Control_feedback" id="summernote-22">{{$data->Quality_Control_feedback}}
                                    </textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <div class="file-attachment-field">
                                            <div disabled class="file-attachment-list" id="Quality_Control_attachment">
                                                ...
                                                @foreach(json_decode($data->Quality_Control_attachment) as $file)
                                                <h6 type="button" class="file-container text-dark" style="background-color: rgb(243, 242, 240);">
                                                    <b>{{ $file }}</b>
                                                    <a href="{{ asset('upload/' . $file) }}" target="_blank"><i class="fa fa-eye text-primary" style="font-size:20px; margin-right:-10px;"></i></a>
                                                    <a  type="button" class="remove-file" data-file-name="{{ $file }}"><i class="fa-solid fa-circle-xmark" style="color:red; font-size:20px;"></i></a>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input {{$data->stage == 5 ? '' : 'disabled' }} type="text" name="Quality_Control_by" id="Quality_Control_by" value={{ $data->Quality_Control_by }} >
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <!-- <div><small class="text-primary">Please select related information</small></div> -->
                                        <input type="date"id="Quality_Control_on" name="Quality_Control_on" value="{{ $data->Quality_Control_on }}" {{$data->stage == 5 ? '' : 'disabled' }}>
                                    </div>
                                </div>
                                  <div class="sub-head">
                                  Quality Assurance
                           ...
                           <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Quality_Assurance_Review" id="Quality_Assurance_Review" value="{{$data->Quality_Assurance_Review}}" {{$data->stage == 5 ? '' : 'disabled' }}>
                                        <option value="">-- Select --</option>
                                        <option @if ($data->Quality_Assurance_Review == 'yes') selected @endif value="yes">Yes</option>
                                        <option  @if ($data->Quality_Assurance_Review == 'no') selected @endif value="no">No</option>
                                        <option  @if ($data->Quality_Assurance_Review == 'na') selected @endif value="na">NA</option>
                                        </select>
                                    </div>
                                </div>
                                @php
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="QualityAssurance_person" id="QualityAssurance_person" value={{$data->QualityAssurance_person}} {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="">-- Select --</option>
                                            @foreach ($users as $user)
                                            <option {{ $data->QualityAssurance_person == $user->id ? 'selected' : '' }}
                                                value="{{ $user->id }}">{{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                                        <textarea class="summernote" name="QualityAssurance_assessment" id="summernote-23">{{ $data->QualityAssurance_assessment }}
                                    </textarea>
                                    </div>
                                </div>   
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                                        <textarea class="summernote" name="QualityAssurance_feedback" id="summernote-24">{{ $data->QualityAssurance_feedback }}
                                    </textarea>
                                    </div>
                                </div>
                                {{-- <div class="col-lg-12">
                                    ...
                                    <div class="group-input">
                                        ...
                                        <div class="file-attachment-field">
                                            <div disabled class="file-attachment-list" id="Quality_Assurance_attachment">
                                                ...
                                                @foreach(json_decode($data->Quality_Assurance_attachment) as $file)
                                                <h6 type="button" class="file-container text-dark" style="background-color: rgb(243, 242, 240);">
                                                    <b>{{ $file }}</b>
                                                    <a href="{{ asset('upload/' . $file) }}" target="_blank"><i class="fa fa-eye text-primary" style="font-size:20px; margin-right:-10px;"></i></a>
                                                    <a  type="button" class="remove-file" data-file-name="{{ $file }}"><i class="fa-solid fa-circle-xmark" style="color:red; font-size:20px;"></i></a>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input {{$data->stage == 5 ? '' : 'disabled' }} type="text" name="QualityAssurance_by" id="QualityAssurance_by" value={{$data->QualityAssurance_by}}  >
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <!-- <div><small class="text-primary">Please select related information</small></div> -->
                                        <input type="date"id="QualityAssurance_on" name="QualityAssurance_on" value="{{ $data->QualityAssurance_on }}" {{$data->stage == 5 ? '' : 'disabled' }}>
                                    </div>
                                </div>
                                <div class="sub-head">
                                Engineering
                           ...
                           <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Engineering_review" id="Engineering_review" value={{$data->Engineering_review}} {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="">-- Select --</option>
                                            <option @if ($data->Engineering_review == 'yes') selected @endif value="yes">Yes</option>
                                            <option  @if ($data->Engineering_review == 'no') selected @endif value="no">No</option>
                                            <option  @if ($data->Engineering_review == 'na') selected @endif value="na">NA</option>
                                        </select>
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Engineering_person" id="Engineering_person" value={{$data->Engineering_person}} {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="">-- Select --</option>
                                            @foreach ($users as $user)
                                            <option {{ $data->Engineering_person == $user->id ? 'selected' : '' }}
                                                value="{{ $user->id }}">{{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                                        <textarea class="summernote" name="Engineering_assessment" id="summernote-25" >{{$data->Engineering_assessment}}
                                    </textarea>
                                    </div>
                                </div>  
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                                        <textarea class="summernote" name="Engineering_feedback" id="summernote-26" >{{$data->Engineering_feedback}}
                                    </textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <div class="file-attachment-field">
                                            <div disabled class="file-attachment-list" id="Engineering_attachment">
                                                ...
                                                @foreach(json_decode($data->Engineering_attachment) as $file)
                                                <h6 type="button" class="file-container text-dark" style="background-color: rgb(243, 242, 240);">
                                                    <b>{{ $file }}</b>
                                                    <a href="{{ asset('upload/' . $file) }}" target="_blank"><i class="fa fa-eye text-primary" style="font-size:20px; margin-right:-10px;"></i></a>
                                                    <a  type="button" class="remove-file" data-file-name="{{ $file }}"><i class="fa-solid fa-circle-xmark" style="color:red; font-size:20px;"></i></a>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input {{$data->stage == 5 ? '' : 'disabled' }} type="text" name="Engineering_by" id="Engineering_by" value={{$data->Engineering_by}}  >
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <!-- <div><small class="text-primary">Please select related information</small></div> -->
                                        <input type="date" id="Engineering_on" name="Engineering_on" value="{{ $data->Engineering_on }}" {{$data->stage == 5 ? '' : 'disabled' }} >
                                    </div>
                                </div>
                                <div class="sub-head">
                           ...
                           <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Analytical_Development_review" id="Analytical_Development_review" value={{$data->Analytical_Development_review}} {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            <option @if ($data->Analytical_Development_review == 'yes') selected @endif value="yes">Yes</option>
                                            <option  @if ($data->Analytical_Development_review == 'no') selected @endif value="no">No</option>
                                            <option  @if ($data->Analytical_Development_review == 'na') selected @endif value="na">NA</option>
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Analytical_Development_person" id="Analytical_Development_person" value={{$data->Analytical_Development_person}} {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            @foreach ($users as $user)
                                            <option {{ $data->Analytical_Development_person == $user->id ? 'selected' : '' }}
                                                value="{{ $user->id }}">{{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="summernote" name="Analytical_Development_assessment" id="summernote-27">{{$data->Analytical_Development_assessment}}
                                    </textarea>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="summernote" name="Analytical_Development_feedback" id="summernote-28">{{$data->Analytical_Development_feedback}}
                                    </textarea>
                                    </div>
                                </div>
                                {{-- <div class="col-lg-12">
                                    ...
                                    <div class="group-input">
                                        ...
                                        <div class="file-attachment-field">
                                            <div disabled class="file-attachment-list" id="Analytical_Development_attachment">
                                                ...
                                                @foreach(json_decode($data->Analytical_Development_attachment) as $file)
                                                <h6 type="button" class="file-container text-dark" style="background-color: rgb(243, 242, 240);">
                                                    <b>{{ $file }}</b>
                                                    <a href="{{ asset('upload/' . $file) }}" target="_blank"><i class="fa fa-eye text-primary" style="font-size:20px; margin-right:-10px;"></i></a>
                                                    <a  type="button" class="remove-file" data-file-name="{{ $file }}"><i class="fa-solid fa-circle-xmark" style="color:red; font-size:20px;"></i></a>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input {{$data->stage == 5 ? '' : 'disabled' }} type="text" name="Analytical_Development_by" id="Analytical_Development_by" value={{$data->Analytical_Development_by}}>
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <!-- <div><small class="text-primary">Please select related information</small></div> -->
                                        <input type="date" id="Analytical_Development_on" name="Analytical_Development_on" value="{{ $data->Analytical_Development_on }}" {{$data->stage == 5 ? '' : 'disabled' }}>
                                    </div>
                                </div>
                                <div class="sub-head">
                           ...
                           <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Kilo_Lab_review" id="Kilo_Lab_review" value={{$data->Kilo_Lab_review}} {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            <option @if ($data->Kilo_Lab_review == 'yes') selected @endif value="yes">Yes</option>
                                            <option @if ($data->Kilo_Lab_review == 'no') selected @endif value="no">No</option>
                                            <option @if ($data->Kilo_Lab_review == 'na') selected @endif value="na">NA</option>
                            ...
                            @endphp
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Kilo_Lab_person" id="Kilo_Lab_person" value={{$data->Kilo_Lab_person}} {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            @foreach ($users as $user)
                                            <option value="{{ $user->id }}" @if ($user->id == $data->Kilo_Lab_person) selected @endif>{{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="summernote" name="Kilo_Lab_assessment" id="summernote-29">{{$data->Kilo_Lab_assessment}}
                                    </textarea>
                                    </div>
                                </div> 
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="summernote" name="Kilo_Lab_feedback" id="summernote-30">{{$data->Kilo_Lab_feedback}}
                                    </textarea>
                                    </div>
                                </div>
                                {{-- <div class="col-lg-12">
                                    ...
                                    <div class="group-input">
                                        ...
                                        <div class="file-attachment-field">
                                            <div disabled class="file-attachment-list" id="Kilo_Lab_attachment">
                                                ...
                                                @foreach(json_decode($data->Kilo_Lab_attachment) as $file)
                                                <h6 type="button" class="file-container text-dark" style="background-color: rgb(243, 242, 240);">
                                                    <b>{{ $file }}</b>
                                                    <a href="{{ asset('upload/' . $file) }}" target="_blank"><i class="fa fa-eye text-primary" style="font-size:20px; margin-right:-10px;"></i></a>
                                                    <a  type="button" class="remove-file" data-file-name="{{ $file }}"><i class="fa-solid fa-circle-xmark" style="color:red; font-size:20px;"></i></a>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input {{$data->stage == 5 ? '' : 'disabled' }} type="text" name="Kilo_Lab_attachment_by" id="Kilo_Lab_attachment_by" value={{$data->Kilo_Lab_attachment_by}} >
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input type="date" id="Kilo_Lab_attachment_on" name="Kilo_Lab_attachment_on" value="{{ $data->Kilo_Lab_attachment_on }}" {{$data->stage == 5 ? '' : 'disabled' }}>
                           ...
                           <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Technology_transfer_review" id="Technology_transfer_review" value="{{$data->Technology_transfer_review}}" {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            <option @if ($data->Technology_transfer_review == 'yes') selected @endif value="yes">Yes</option>
                                            <option @if ($data->Technology_transfer_review == 'no') selected @endif value="no">No</option>
                                            <option @if ($data->Technology_transfer_review == 'na') selected @endif value="na">NA</option>
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Technology_transfer_person" id="Technology_transfer_person" value={{$data->Technology_transfer_person}} {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            @foreach ($users as $user)
                                            <option value="{{ $user->id }}" @if($user->id == $data->Technology_transfer_person) selected @endif>{{ $user->name }}</option>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="summernote" name="Technology_transfer_assessment" id="summernote-31">{{$data->Technology_transfer_assessment}}
                                    </textarea>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="summernote" name="Technology_transfer_feedback" id="summernote-32">{{$data->Technology_transfer_feedback}}
                                    </textarea>
                                    </div>
                                </div>
                                {{-- <div class="col-lg-12">
                                    ...
                                    <div class="group-input">
                                        ...
                                        <div class="file-attachment-field">
                                            <div disabled class="file-attachment-list" id="Technology_transfer_attachment">
                                                ...
                                                @foreach(json_decode($data->Technology_transfer_attachment) as $file)
                                                <h6 type="button" class="file-container text-dark" style="background-color: rgb(243, 242, 240);">
                                                    <b>{{ $file }}</b>
                                                    <a href="{{ asset('upload/' . $file) }}" target="_blank"><i class="fa fa-eye text-primary" style="font-size:20px; margin-right:-10px;"></i></a>
                                                    <a  type="button" class="remove-file" data-file-name="{{ $file }}"><i class="fa-solid fa-circle-xmark" style="color:red; font-size:20px;"></i></a>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input {{$data->stage == 5 ? '' : 'disabled' }} type="text" name="Technology_transfer_by" id="Technology_transfer_by" value={{$data->Technology_transfer_by}}  >
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input type="date" id="Technology_transfer_on" name="Technology_transfer_on" value="{{ $data->Technology_transfer_on }}" {{$data->stage == 5 ? '' : 'disabled' }}>
                                    </div>
                                </div>
                                <div class="sub-head">
                           ...
                           <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Environment_Health_review" id="Environment_Health_review" {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            <option @if ($data->Environment_Health_review == 'yes') selected @endif value="yes">Yes</option>
                                            <option @if ($data->Environment_Health_review == 'no') selected @endif value="no">No</option>
                                            <option @if ($data->Environment_Health_review == 'na') selected @endif value="na">NA</option>
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Environment_Health_Safety_person" id="Environment_Health_Safety_person" {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            @foreach ($users as $user)
                                            <option {{ $data->Environment_Health_Safety_person == $user->id ? 'selected' : '' }}
                                                value="{{ $user->id }}">{{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="summernote" name="Health_Safety_assessment" id="summernote-33">{{$data->Health_Safety_assessment}}
                                    </textarea>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="summernote" name="Health_Safety_feedback" id="summernote-34">{{$data->Health_Safety_feedback}}
                                    </textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <div class="file-attachment-field">
                                            <div disabled class="file-attachment-list" id="Environment_Health_Safety_attachment">
                                                @if ($data->Environment_Health_Safety_attachment)
                                                @foreach(json_decode($data->Environment_Health_Safety_attachment) as $file)
                                                <h6 type="button" class="file-container text-dark" style="background-color: rgb(243, 242, 240);">
                                                    <b>{{ $file }}</b>
                                                    <a href="{{ asset('upload/' . $file) }}" target="_blank"><i class="fa fa-eye text-primary" style="font-size:20px; margin-right:-10px;"></i></a>
                                                    <a  type="button" class="remove-file" data-file-name="{{ $file }}"><i class="fa-solid fa-circle-xmark" style="color:red; font-size:20px;"></i></a>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input {{$data->stage == 5 ? '' : 'disabled' }} type="text" name="Environment_Health_Safety_by" id="Environment_Health_Safety_by" value={{$data->Environment_Health_Safety_by}}  >
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input {{$data->stage == 5 ? '' : 'disabled' }} type="date" id="Environment_Health_Safety_on" name="Environment_Health_Safety_on" value={{ $data->Environment_Health_Safety_on }} >
                           ...
                           <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Human_Resource_review" id="Human_Resource_review" value={{$data->Human_Resource_review}} {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            <option @if ($data->Human_Resource_review == 'yes') selected @endif value="yes">Yes</option>
                                            <option @if ($data->Human_Resource_review == 'no') selected @endif value="no">No</option>
                                            <option @if ($data->Human_Resource_review == 'na') selected @endif value="na">NA</option>
                                        </select>
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Human_Resource_person" id="Human_Resource_person" value={{$data->Human_Resource_person}} {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            @foreach ($users as $user)
                                            <option {{ $data->Human_Resource_person == $user->id ? 'selected' : '' }}
                                                value="{{ $user->id }}">{{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="summernote" name="Human_Resource_assessment" id="summernote-35">{{$data->Human_Resource_assessment}}
                                    </textarea>
                                    </div>
                                </div> 
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="summernote" name="Human_Resource_feedback" id="summernote-36">{{$data->Human_Resource_feedback}}
                                    </textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="group-input">
                                        ...
                                        <div class="file-attachment-field">
                                            <div disabled class="file-attachment-list" id="Human_Resource_attachment">
                                                ...
                                                @foreach(json_decode($data->Human_Resource_attachment) as $file)
                                                <h6 type="button" class="file-container text-dark" style="background-color: rgb(243, 242, 240);">
                                                    <b>{{ $file }}</b>
                                                    <a href="{{ asset('upload/' . $file) }}" target="_blank"><i class="fa fa-eye text-primary" style="font-size:20px; margin-right:-10px;"></i></a>
                                                    <a  type="button" class="remove-file" data-file-name="{{ $file }}"><i class="fa-solid fa-circle-xmark" style="color:red; font-size:20px;"></i></a>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input {{$data->stage == 5 ? '' : 'disabled' }} type="text" name="Human_Resource_by" id="Human_Resource_by" value={{$data->Human_Resource_by}} >
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input type="date" id="Environment_Health_Safety_on" name="Environment_Health_Safety_on" value="{{ $data->Environment_Health_Safety_on }}" {{$data->stage == 5 ? '' : 'disabled' }}>
                           ...
                           <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name=" Information_Technology_review" id=" Information_Technology_review" value={{$data->Information_Technology_review}} {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            <option @if ($data->Information_Technology_review == 'yes') selected @endif value="yes">Yes</option>
                                            <option @if ($data->Information_Technology_review == 'no') selected @endif value="no">No</option>
                                            <option @if ($data->Information_Technology_review == 'na') selected @endif value="na">NA</option>
                                        </select>
                            ...
                            @endphp
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name=" Information_Technology_person" id=" Information_Technology_person" value={{$data->Information_Technology_person}} {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            @foreach ($users as $user)
                                            <option {{ $data->Information_Technology_person == $user->id ? 'selected' : '' }}
                                                value="{{ $user->id }}">{{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="summernote" name="Information_Technology_assessment" id="summernote-37">{{$data->Information_Technology_assessment}}
                                    </textarea>
                                    </div>
                                </div>  
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="summernote" name="Information_Technology_feedback" id="summernote-38">{{$data->Information_Technology_feedback}}
                                    </textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="group-input">
                                        ...
                                        <div class="file-attachment-field">
                                            <div disabled class="file-attachment-list" id="Information_Technology_attachment">
                                                ...
                                                @foreach(json_decode($data->Information_Technology_attachment) as $file)
                                                <h6 type="button" class="file-container text-dark" style="background-color: rgb(243, 242, 240);">
                                                    <b>{{ $file }}</b>
                                                    <a href="{{ asset('upload/' . $file) }}" target="_blank"><i class="fa fa-eye text-primary" style="font-size:20px; margin-right:-10px;"></i></a>
                                                    <a  type="button" class="remove-file" data-file-name="{{ $file }}"><i class="fa-solid fa-circle-xmark" style="color:red; font-size:20px;"></i></a>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input {{$data->stage == 5 ? '' : 'disabled' }} type="text" name="Information_Technology_by" id="Information_Technology_by" value={{$data->Information_Technology_by}} >
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input type="date" name="Information_Technology_on" id="Information_Technology_on" value="{{$data->Information_Technology_on}}" {{$data->stage == 5 ? '' : 'disabled' }}>
                                    </div>
                                </div>
                                <div class="sub-head">
                                Project Management
                           ...
                           <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Project_management_review" id="Project_management_review" value={{$data->Project_management_review}} {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            <option @if ($data->Project_management_review == 'yes') selected @endif value="yes">Yes</option>
                                            <option @if ($data->Project_management_review == 'no') selected @endif value="no">No</option>
                                            <option @if ($data->Project_management_review == 'na') selected @endif value="na">NA</option>
                                        </select>
                                    </div>
                           </div>
                                    @php
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Project_management_person" id="Project_management_person" value="{{$data->Project_management_person}}" {{$data->stage ==5 ? '' : 'disabled' }}>
                                            @foreach ($users as $user)
                                            <option {{ $data->Project_management_person == $user->id ? 'selected' : '' }}value="{{ $user->id }}">{{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="summernote" name="Project_management_assessment" id="summernote-39">{{$data->Project_management_assessment}}
                                    </textarea>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="summernote" name="Project_management_feedback" id="summernote-40">{{$data->Project_management_feedback}}
                                    </textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="group-input">
                                        ...
                                        <div class="file-attachment-field">
                                            <div disabled class="file-attachment-list" id="Project_management_attachment">
                                                ...
                                                @foreach(json_decode($data->Project_management_attachment) as $file)
                                                <h6 type="button" class="file-container text-dark" style="background-color: rgb(243, 242, 240);">
                                                    <b>{{ $file }}</b>
                                                    <a href="{{ asset('upload/' . $file) }}" target="_blank"><i class="fa fa-eye text-primary" style="font-size:20px; margin-right:-10px;"></i></a>
                                                    <a  type="button" class="remove-file" data-file-name="{{ $file }}"><i class="fa-solid fa-circle-xmark" style="color:red; font-size:20px;"></i></a>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input {{$data->stage == 5 ? '' : 'disabled' }} type="text" name="Project_management_by" id="Project_management_by" value={{$data->Project_management_by}} >
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input type="date" name="Project_management_on" id="Project_management_on" value="{{$data->Project_management_on}}" {{$data->stage == 5 ? '' : 'disabled' }}>
                           ...
                           <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Other1_review" id="Other1_review" value="{{ $data->Other1_review }}" {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            <option @if ($data->Other1_review == 'yes') selected @endif value="yes">Yes</option>
                                            <option @if ($data->Other1_review == 'no') selected @endif value="no">No</option>
                                            <option @if ($data->Other1_review == 'na') selected @endif value="na">NA</option>
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Other1_person" id="Other1_person" {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            @foreach ($users as $user)
                                            <option {{ $data->Other1_person == $user->id ? 'selected' : '' }}value="{{ $user->id }}">{{ $user->name }}</option>
                                            @endforeach
                                ...
                                <div class="col-lg-12">
                                    <div class="group-input">
                                        ...
                                        <select name="Other1_Department_person" id="Other1_Department_person" value="{{ $data->Other1_Department_person }}" {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            <option @if ($data->Other1_Department_person == 'Production') selected @endif value="Production">Production</option>
                                            <option @if ($data->Other1_Department_person == 'Warehouse') selected @endif value="Warehouse"> Warehouse</option>
                                            <option @if ($data->Other1_Department_person == 'Quality_Control') selected @endif value="Quality_Control">Quality Control</option>  
                                            <option @if ($data->Other1_Department_person == 'Quality_Assurance') selected @endif value="Quality_Assurance">Quality Assurance</option>
                                            <option @if ($data->Other1_Department_person == 'Engineering') selected @endif value="Engineering">Engineering</option>
                                            <option @if ($data->Other1_Department_person == 'Analytical_Development_Laboratory') selected @endif value="Analytical_Development_Laboratory">Analytical Development Laboratory</option> 
                                            <option @if ($data->Other1_Department_person == 'Process_Development_Lab') selected @endif value="Process_Development_Lab">Process Development Laboratory / Kilo Lab</option>
                                            <option @if ($data->Other1_Department_person == 'Technology_transfer_Design') selected @endif value="Technology transfer/Design"> Technology Transfer/Design</option>
                                            <option @if ($data->Other1_Department_person == 'Environment_Health_Safety') selected @endif value="Environment, Health & Safety">Environment, Health & Safety</option>   
                                            <option @if ($data->Other1_Department_person == 'Human_Resource_Administration') selected @endif value="Human Resource & Administration">Human Resource & Administration</option>
                                            <option @if ($data->Other1_Department_person == 'Information_Technology') selected @endif value="Information Technology">Information Technology</option>
                                            <option @if ($data->Other1_Department_person == 'Project_management') selected @endif value="Project management">Project management</option>  
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="summernote" name="Other1_assessment" id="summernote-41">{{$data->Other1_assessment}}
                                    </textarea>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="summernote" name="Other1_feedback" id="summernote-42">{{$data->Other1_feedback}}
                                    </textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <div class="file-attachment-field">
                                            <div disabled class="file-attachment-list" id="Other1_attachment" name ="Other1_attachment">
                                                ...
                                                @foreach(json_decode($data->Other1_attachment) as $file)
                                                <h6 type="button" class="file-container text-dark" style="background-color: rgb(243, 242, 240);">
                                                    <b>{{ $file }}</b>
                                                    <a href="{{ asset('upload/' . $file) }}" target="_blank"><i class="fa fa-eye text-primary" style="font-size:20px; margin-right:-10px;"></i></a>
                                                    <a  type="button" class="remove-file" data-file-name="{{ $file }}"><i class="fa-solid fa-circle-xmark" style="color:red; font-size:20px;"></i></a>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input {{$data->stage == 5 ? '' : 'disabled' }} type="text" name="Other1_by" id="Other1_by" value={{$data->Other1_by}}>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input type="date" name="Other1_on" id="Other1_on" value="{{$data->Other1_on}}"  {{$data->stage == 5 ? '' : 'disabled' }}>
                           ...
                           <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Other2_review" id="Other2_review" value="{{ $data->Other2_review }}" {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            <option @if ($data->Other2_review == 'yes') selected @endif value="yes">Yes</option>
                                            <option @if ($data->Other2_review == 'no') selected @endif value="no">No</option>
                                            <option @if ($data->Other2_review == 'na') selected @endif value="na">NA</option>
                                        </select>
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Other2_person" id="Other2_person" value="{{$data->Other2_person}}" {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            @foreach ($users as $user)
                                            <option {{ $data->Other2_person == $user->id ? 'selected' : '' }}
                                                value="{{ $user->id }}">{{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-12">
                                    <div class="group-input">
                                        ...
                                        <select name="Other2_Department_person" id="Other2_Department_person" value="{{$data->Other2_Department_person}}" {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            <option @if($data->Other2_Department_person == 'Production') selected @endif value="Production">Production</option>
                                            <option @if($data->Other2_Department_person == 'Warehouse') selected @endif value="Warehouse">Warehouse</option>
                                            <option @if($data->Other2_Department_person == 'Quality_Control') selected @endif value="Quality_Control">Quality Control</option>
                                            <option @if($data->Other2_Department_person == 'Quality_Assurance') selected @endif value="Quality_Assurance">Quality Assurance</option>
                                            <option @if($data->Other2_Department_person == 'Engineering') selected @endif value="Engineering">Engineering</option>
                                            <option @if($data->Other2_Department_person == 'Analytical_Development_Laboratory') selected @endif value="Analytical_Development_Laboratory">Analytical Development Laboratory</option>
                                            <option @if($data->Other2_Department_person == 'Process_Development_Lab') selected @endif value="Process_Development_Lab">Process Development Laboratory / Kilo Lab</option>
                                            <option @if($data->Other2_Department_person == 'Technology_transfer_Design') selected @endif value="Technology_transfer_Design">Technology Transfer/Design</option>
                                            <option @if($data->Other2_Department_person == 'Environment_Health_Safety') selected @endif value="Environment_Health_Safety">Environment, Health & Safety</option>
                                            <option @if($data->Other2_Department_person == 'Human_Resource_Administration') selected @endif value="Human_Resource_Administration">Human Resource & Administration</option>
                                            <option @if($data->Other2_Department_person == 'Information_Technology') selected @endif value="Information_Technology">Information Technology</option>
                                            <option @if($data->Other2_Department_person == 'Project_management') selected @endif value="Project_management">Project management</option>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="summernote" name="Other2_Assessment" id="summernote-43">{{$data->Other2_Assessment}}
                                    </textarea>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="summernote" name="Other2_feedback" id="summernote-44">{{$data->Other2_feedback}}
                                    </textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <div class="file-attachment-field">
                                            <div disabled class="file-attachment-list" id="Other2_attachment" name="Other2_attachment">
                                                ...
                                                @foreach(json_decode($data->Other2_attachment) as $file)
                                                <h6 type="button" class="file-container text-dark" style="background-color: rgb(243, 242, 240);">
                                                    <b>{{ $file }}</b>
                                                    <a href="{{ asset('upload/' . $file) }}" target="_blank"><i class="fa fa-eye text-primary" style="font-size:20px; margin-right:-10px;"></i></a>
                                                    <a  type="button" class="remove-file" data-file-name="{{ $file }}"><i class="fa-solid fa-circle-xmark" style="color:red; font-size:20px;"></i></a>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input {{$data->stage == 5 ? '' : 'disabled' }} type="text" name="Other2_by" id="Other2_by" value={{$data->Other2_by}} >
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input type="date" name="Other2_on" id="Other2_on" value="{{$data->Other2_on}}" {{$data->stage == 5 ? '' : 'disabled' }}>
                                    </div>
                                </div>
                           ...
                           <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Other3_review" id="Other3_review" value="{{ $data->Other3_review }}" {{$data->stage == 5 ? '' : 'disabled' }}>
                                                <option value="0">-- Select --</option>
                                                <option @if ($data->Other3_review == 'yes') selected @endif value="yes">Yes</option>
                                                <option @if ($data->Other3_review == 'no') selected @endif value="no">No</option>
                                                <option @if ($data->Other3_review == 'na') selected @endif value="na">NA</option>
                                            </select>
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Other3_person" id="Other3_person" value="{{$data->Other3_person}}" {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            @foreach ($users as $user)
                                            <option {{ $data->Other3_person == $user->id ? 'selected' : '' }}
                                                value="{{ $user->id }}">{{ $user->name }}</option>
                                            @endforeach
                                ...
                                <div class="col-lg-12">
                                    <div class="group-input">
                                        ...
                                        <select name="Other3_Department_person" id="Other3_Department_person" value="{{$data->Other3_Department_person}}" {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            <option @if($data->Other3_Department_person == 'Production') selected @endif value="Production">Production</option>
                                            <option @if($data->Other3_Department_person == 'Warehouse') selected @endif value="Warehouse">Warehouse</option>
                                            <option @if($data->Other3_Department_person == 'Quality_Control') selected @endif value="Quality_Control">Quality Control</option>
                                            <option @if($data->Other3_Department_person == 'Quality_Assurance') selected @endif value="Quality_Assurance">Quality Assurance</option>
                                            <option @if($data->Other3_Department_person == 'Engineering') selected @endif value="Engineering">Engineering</option>
                                            <option @if($data->Other3_Department_person == 'Analytical_Development_Laboratory') selected @endif value="Analytical_Development_Laboratory">Analytical Development Laboratory</option>
                                            <option @if($data->Other3_Department_person == 'Process_Development_Lab') selected @endif value="Process_Development_Lab">Process Development Laboratory / Kilo Lab</option>
                                            <option @if($data->Other3_Department_person == 'Technology_transfer_Design') selected @endif value="Technology_transfer_Design">Technology Transfer/Design</option>
                                            <option @if($data->Other3_Department_person == 'Environment_Health_Safety') selected @endif value="Environment_Health_Safety">Environment, Health & Safety</option>
                                            <option @if($data->Other3_Department_person == 'Human_Resource_Administration') selected @endif value="Human_Resource_Administration">Human Resource & Administration</option>
                                            <option @if($data->Other3_Department_person == 'Information_Technology') selected @endif value="Information_Technology">Information Technology</option>
                                            <option @if($data->Other3_Department_person == 'Project_management') selected @endif value="Project_management">Project management</option>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="summernote" name="Other3_Assessment" id="summernote-45">{{$data->Other3_Assessment}}
                                    </textarea>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="summernote" name="Other3_feedback" id="summernote-46">{{$data->Other3_Assessment}}
                                    </textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <div class="file-attachment-field">
                                            <div disabled class="file-attachment-list" id="Other3_attachment" name="Other3_attachment">
                                                ...
                                                @foreach(json_decode($data->Other3_attachment) as $file)
                                                <h6 type="button" class="file-container text-dark" style="background-color: rgb(243, 242, 240);">
                                                    <b>{{ $file }}</b>
                                                    <a href="{{ asset('upload/' . $file) }}" target="_blank"><i class="fa fa-eye text-primary" style="font-size:20px; margin-right:-10px;"></i></a>
                                                    <a  type="button" class="remove-file" data-file-name="{{ $file }}"><i class="fa-solid fa-circle-xmark" style="color:red; font-size:20px;"></i></a>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input {{$data->stage == 5 ? '' : 'disabled' }} type="text" name="Other3_by" id="Other3_by" value={{ $data->Other3_by }}>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input type="date" name="Other3_on" id="Other3_on" value="{{$data->Other3_on}}" {{$data->stage == 5 ? '' : 'disabled' }}>
                                    </div>
                                </div>
                                <div class="sub-head">
                           ...
                           <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Other4_review" id="Other4_review" value="{{ $data->Other4_review }}"{{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            <option @if ($data->Other4_review == 'yes') selected @endif value="yes">Yes</option>
                                            <option @if ($data->Other4_review == 'no') selected @endif value="no">No</option>
                                            <option @if ($data->Other4_review == 'na') selected @endif value="na">NA</option>
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Other4_person" id="Other4_person" value={{$data->Other4_person}} {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            @foreach ($users as $user)
                                            <option {{ $data->Other4_person == $user->id ? 'selected' : '' }}
                                                value="{{ $user->id }}">{{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-12">
                                    <div class="group-input">
                                        ...
                                        <select name="Other4_Department_person" id="Other4_Department_person" value="{{$data->Other4_Department_person}}" {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            <option @if($data->Other4_Department_person == 'Production') selected @endif value="Production">Production</option>
                                            <option @if($data->Other4_Department_person == 'Warehouse') selected @endif value="Warehouse">Warehouse</option>
                                            <option @if($data->Other4_Department_person == 'Quality_Control') selected @endif value="Quality_Control">Quality Control</option>
                                            <option @if($data->Other4_Department_person == 'Quality_Assurance') selected @endif value="Quality_Assurance">Quality Assurance</option>
                                            <option @if($data->Other4_Department_person == 'Engineering') selected @endif value="Engineering">Engineering</option>
                                            <option @if($data->Other4_Department_person == 'Analytical_Development_Laboratory') selected @endif value="Analytical_Development_Laboratory">Analytical Development Laboratory</option>
                                            <option @if($data->Other4_Department_person == 'Process_Development_Lab') selected @endif value="Process_Development_Lab">Process Development Laboratory / Kilo Lab</option>
                                            <option @if($data->Other4_Department_person == 'Technology_transfer_Design') selected @endif value="Technology_transfer_Design">Technology Transfer/Design</option>
                                            <option @if($data->Other4_Department_person == 'Environment_Health_Safety') selected @endif value="Environment_Health_Safety">Environment, Health & Safety</option>
                                            <option @if($data->Other4_Department_person == 'Human_Resource_Administration') selected @endif value="Human_Resource_Administration">Human Resource & Administration</option>
                                            <option @if($data->Other4_Department_person == 'Information_Technology') selected @endif value="Information_Technology">Information Technology</option>
                                            <option @if($data->Other4_Department_person == 'Project_management') selected @endif value="Project_management">Project management</option>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="summernote" name="Other4_Assessment" id="summernote-47">{{$data->Other4_Assessment}}
                                    </textarea>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="summernote" name="Other4_feedback" id="summernote-48">{{$data->Other4_feedback}}
                                    </textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <div class="file-attachment-field">
                                            <div disabled class="file-attachment-list" id="Other4_attachment" name="Other4_attachment">
                                                ...
                                                @foreach(json_decode($data->Other4_attachment) as $file)
                                                <h6 type="button" class="file-container text-dark" style="background-color: rgb(243, 242, 240);">
                                                    <b>{{ $file }}</b>
                                                    <a href="{{ asset('upload/' . $file) }}" target="_blank"><i class="fa fa-eye text-primary" style="font-size:20px; margin-right:-10px;"></i></a>
                                                    <a  type="button" class="remove-file" data-file-name="{{ $file }}"><i class="fa-solid fa-circle-xmark" style="color:red; font-size:20px;"></i></a>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input {{$data->stage == 5 ? '' : 'disabled' }} type="text" name="Other4_by" id="Other4_by" value={{$data->Other4_by}}>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input type="date" name="Other4_on" id="Other4_on" value="{{$data->Other4_on}}" {{$data->stage == 5 ? '' : 'disabled' }}>
                           ...
                           <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Other5_review" id="Other5_review" value="{{ $data->Other5_review }}"{{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            <option @if ($data->Other5_review == 'yes') selected @endif value="yes">Yes</option>
                                            <option @if ($data->Other5_review == 'no') selected @endif value="no">No</option>
                                            <option @if ($data->Other5_review == 'na') selected @endif value="na">NA</option>
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Other5_person" id="Other5_person" value={{$data->Other5_person}} {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            @foreach ($users as $user)
                                            <option {{ $data->Other5_person == $user->id ? 'selected' : '' }}
                                                value="{{ $user->id }}">{{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-12">
                                    <div class="group-input">
                                        ...
                                        <select name="Other5_Department_person" id="Other5_Department_person" value={{$data->Other5_Department_person}} {{$data->stage == 5 ? '' : 'disabled' }}>
                                            <option value="0">-- Select --</option>
                                            <option @if($data->Other5_Department_person == 'Production') selected @endif value="Production">Production</option>
                                            <option @if($data->Other5_Department_person == 'Warehouse') selected @endif value="Warehouse">Warehouse</option>
                                            <option @if($data->Other5_Department_person == 'Quality_Control') selected @endif value="Quality_Control">Quality Control</option>
                                            <option @if($data->Other5_Department_person == 'Quality_Assurance') selected @endif value="Quality_Assurance">Quality Assurance</option>
                                            <option @if($data->Other5_Department_person == 'Engineering') selected @endif value="Engineering">Engineering</option>
                                            <option @if($data->Other5_Department_person == 'Analytical_Development_Laboratory') selected @endif value="Analytical_Development_Laboratory">Analytical Development Laboratory</option>
                                            <option @if($data->Other5_Department_person == 'Process_Development_Lab') selected @endif value="Process_Development_Lab">Process Development Laboratory / Kilo Lab</option>
                                            <option @if($data->Other5_Department_person == 'Technology_transfer_Design') selected @endif value="Technology_transfer_Design">Technology Transfer/Design</option>
                                            <option @if($data->Other5_Department_person == 'Environment_Health_Safety') selected @endif value="Environment_Health_Safety">Environment, Health & Safety</option>
                                            <option @if($data->Other5_Department_person == 'Human_Resource_Administration') selected @endif value="Human_Resource_Administration">Human Resource & Administration</option>
                                            <option @if($data->Other5_Department_person == 'Information_Technology') selected @endif value="Information_Technology">Information Technology</option>
                                            <option @if($data->Other5_Department_person == 'Project_management') selected @endif value="Project_management">Project management</option>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="summernote" name="Other5_Assessment" id="summernote-49">{{$data->Other5_Assessment}}
                                    </textarea>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <textarea class="summernote" name="Other5_feedback" id="summernote-50">{{$data->Other5_feedback}}
                                    </textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input {{$data->stage == 5 ? '' : 'disabled' }} type="text" name="Other5_by" id="Other5_by" value={{$data->Other5_by}}>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input type="date" name="Other5_on" id="Other5_on" value="{{$data->Other5_on}}" {{$data->stage == 5 ? '' : 'disabled' }}>
                                    </div>
                                </div>
