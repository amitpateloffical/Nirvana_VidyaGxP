            ...
            $('#OOT_Results').click(function(e) {
                function generateTableRow(serialNumber) {
                    ...
                    var html =
                        ...
                        '<td><input disabled type="text" name="serial[]" value="' + serialNumber +
                        '"></td>' +
                        '<td><input type="text" name="AR_Number[]"></td>' +
                        '<td><input type="text" name="Test_Name_Of_OOT[]"></td>' +
                        '<td><input type="text" name="Result_Obtained[]"></td>' +
                        '<td><input type="text" name="Initial_Interval_Details[]"></td>' +
                        '<td><input type="text" name="Previous_Interval_Details[]"></td>' +
                        '<td><input type="text" name="Difference_Of_Results[]"></td>' +
                        '<td><input type="text" name="Trend_Limit[]"></td>' +
...
<script>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="OOS_Details_details" style="width: 100%;">
                                    ...
                                    <tbody>
                                        ...
                                        <td><input type="text" name="parent_oos_details[0][ar_number]"></td>
                                        <td><input type="text" name="parent_oos_details[0][test_name_of_oos]"></td>
                                        <td><input type="text" name="parent_oos_details[0][result obtained]"></td>
                                        <td><input type="text" name="parent_oos_details[0][specification_limit]"></td>
                                    </tbody>
                                </table>
                            </div>
    ...
    <!-- ---------------------------grid-4 -------------------------------- -->
                        ...
                        <div class="group-input">
                            <label for="audit-agenda-grid">
                                (Parent) OOT Results
                                <button type="button" name="audit-agenda-grid" id="OOT_Results">+</button>
                                <span class="text-primary" data-bs-toggle="modal"
                                    data-bs-target="#document-details-field-instruction-modal"
                                    style="font-size: 0.8rem; font-weight: 400; cursor: pointer;">
                                    (Launch Instruction)
                        ...
                        <div class="col-lg-6">
                            <div class="group-input">
                                ...
                                <select multiple id="reference_record" name="PhaseIIQCReviewProposedBy[]" id="">
                                    <option value="">Re-Calculation Of Results By Omiting The Error</option>
                                    <option value="">Re-Injection Of Original Vials of Sample</option>
                                    <option value="">Injection Of Re-Filled Sample Solution</option>
                                </select>
                            </div>
                        </div>
            ...
            <div id="CCForm3" class="inner-block cctabcontent">
                <div class="inner-block-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="group-input">
                                <label for="Verification Attachments">Veification Attachment</label>
                                {{-- <div><small class="text-primary">Please Attach all relevant or supporting documents</small></div> --}}
                                <div class="file-attachment-field">
