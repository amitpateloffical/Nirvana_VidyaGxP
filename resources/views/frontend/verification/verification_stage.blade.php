...
<div class="inner-block state-block">
    ...
    <div class="main-head">Record Workflow </div>
        <div class="d-flex" style="gap:20px;">
            ...
            @endphp
            <button class="button_theme1"> <a class="text-white" href="{{ route('audit_trial', $verification->id) }}"> Audit Trail </a> </button>
            ...
            @elseif($verification->stage == 2 && (in_array([4,14], $userRoleIds) || in_array(18, $userRoleIds)))
            ...
            @elseif($verification->stage == 3 && (in_array(9, $userRoleIds) || in_array(18, $userRoleIds)))
